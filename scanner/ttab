...
kTHIS_VERSION='v0.9.0' # NOTE: This assignment is automatically updated by `make version VER=<newVer>` - DO keep the 'v' prefix.
...
if (( gnomeTerminal )); then
  ...
  (( inBackground == 1 )) && dieSyntax "The -g option is not supported in $terminalApp."
